...
*/}}
{{- define "payments.configMapName" -}}
{{- if .Values.configMap.create }}
{{- default (include "payments.fullname" .) .Values.configMap.name }}
{{- else }}
...
{{/* podAnnotations */}}
{{- define "payments.podAnnotations" -}}
...
{{- define "payments.mysql.fullname" -}}
{{- include "payments.fullname" . }}-mysql
{{- end -}}

{{/*
Common labels for mysql
*/}}
{{- define "payments.mysql.labels" -}}
helm.sh/chart: {{ include "payments.chart" . }}
{{ include "payments.mysql.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
*/}}
{{- define "payments.mysql.selectorLabels" -}}
app.kubernetes.io/name: {{ include "payments.fullname" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
